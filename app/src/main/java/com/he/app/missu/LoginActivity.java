...
import com.he.app.tools.bmob.BmobConstants;
import com.he.app.tools.BaseActivity;
import com.he.app.tools.ui.DialogTips;
import com.he.app.tools.utils.CommonUtils;
...
public class LoginActivity extends BaseActivity implements OnClickListener {
    ...
    public void showNotice() {
        DialogTips dialog = new DialogTips(this,"Info",getResources().getString(R.string.show_notice), "OK",true,true);
        // 设置成功事件
    ...
    private void login(){
        ...
        um.login(name, password, new SaveListener() {
